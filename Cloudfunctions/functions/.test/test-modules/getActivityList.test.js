...
describe("Testing that the developer can call API to getActivityList() and receive redirection URL: ", () => {
    before ('set up the userIds in the test User doc', async () => {
        ...
        .set({
            ...
            "garmin_access_token" :"d14a1877-e331-43ac-8fa8-de8162b23fa7",
            "garmin_user_id": "bf26c167-6fea-4a96-bcc6-588a0ee6c0e3",
            "garmin_client_id": "d3dd1cc9-06b2-4b3e-9eb4-8a40cbd8e53f",
            "garmin_access_token_secret": "7UoTR7bt9SoMzaKIAnLico5nL76rdfTKxdK"
        }, {merge: true});
...
const wahooResponse = {body: '{"workouts":[{"id":161442834,"starts":"2022-07-28T12:17:26.000Z","minutes":0,"name":"Cycling","plan_id":null,"workout_token":"ELEMNT AE48:289","workout_type_id":0,"workout_summary":{"id":153936466,"ascent_accum":"70.0","calories_accum":"540.0","cadence_avg":"87.38","distance_accum":"19636.47","duration_active_accum":"2057.0","duration_paused_accum":"29.0","duration_total_accum":"2086.0","heart_rate_avg":"0.0","power_avg":"263.0","power_bike_np_last":"281.0","power_bike_tss_last":"48.9","speed_avg":"5.15","files":[{"url":"https://cdn.wahooligan.com/wahoo-cloud/production/uploads/workout_file/file/7IrvLZe89WV4QuaEcaCaWA/2022-05-08-080131-ELEMNT_AE48-260-0.fit"}],"created_at":"2022-05-08T11:31:43.000Z","updated_at":"2022-05-11T18:43:01.000Z"},"created_at":"2022-05-08T11:31:43.000Z","updated_at":"2022-05-08T11:31:43.000Z"}],"total":1,"page":1,"per_page":30,"order":"descending","sort":"starts"}'
};
